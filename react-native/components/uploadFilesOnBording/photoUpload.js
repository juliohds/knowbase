...
export default class PhotoUpload extends React.Component {
  ...
  state = {
    maxHeight: this.props.height || 1024,
    maxWidth: this.props.width || 1024,
  ...
  options = {
    ...
    title: this.props.photoPickerTitle || `${ I18n.t("imageChooseA") }:`,
    cancelButtonTitle: I18n.t("cancelLabel"),
    takePhotoButtonTitle: I18n.t("pictureTake"),
    chooseFromLibraryButtonTitle: I18n.t("pictureChooseLibrary"),
    storageOptions: {
      skipBackup: true,
      path: "images"
    },
  ...
  render() {
    return (
      <View style={[styles.photoUploadContainer, this.props.containerStyle]}>
        <TouchableOpacity
